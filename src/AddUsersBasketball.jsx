...
class UnconnectedAddUsersBasketball extends Component {
  constructor(props) {
    super(props);
    this.state = {
      event: {
...
let AddUsersBasketball = connect(mapStateToProps)(
  UnconnectedAddUsersBasketball
);

export default AddUsersBasketball;
